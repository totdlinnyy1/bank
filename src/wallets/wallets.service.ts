...
export class WalletsService {
    ...
    async deposit(
        ...
        this._logger.debug('SAVE DEPOSIT DATA')
        // Saving a transaction
        const trans = await this._transactionRepository.save({
    ...
    async withdraw(
        ...
        this._logger.debug('SAVE WITHDRAW DATA')
        // Saving a transaction
        const trans = await this._transactionRepository.save({
    ...
    async transaction(
        ...
        this._logger.debug('SAVE TRANSACTION DATA')
        // Saving a transaction
        const trans = await this._transactionRepository.save({
